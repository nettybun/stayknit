...
import type { Signal, ComputedSignal } from 'haptic/s';

// TODO: Publish this in Haptic
type AnySignal<T> = Signal<T> | ComputedSignal<T>;

const HeartIcon = ({ size }: { size: AnySignal<string|number> }): h.JSX.Element => {
...
const SvelteIcon = ({ size }: { size: AnySignal<string|number> }): h.JSX.Element => {
